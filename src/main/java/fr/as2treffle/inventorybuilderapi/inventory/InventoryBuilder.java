...
public class InventoryBuilder {
    ...
    public static Inventory buildInventory(Player player, String file_path) {
        ...
        YamlConfiguration inventory_file = FileManager.getInventoryFile(player, file_path);
        return buildInventory(player, inventory_file, new ArrayList<>());
    }

    @SuppressWarnings("all")
    public static Inventory buildInventory(Player player, YamlConfiguration inventory_file, ArrayList<Data> data_list) {

        HashMap<Boolean, ArrayList<Object>> result = getInventorySettings(inventory_file);

        if (data_list.isEmpty()) {
            DataManager.initializeData(player, inventory_file);
        }
        else {
            DataManager.setDataValues(player.getUniqueId(), data_list);
        }
    ...
    private static HashMap<Boolean, ArrayList<Object>> getInventorySettings(YamlConfiguration inventory_file) {
